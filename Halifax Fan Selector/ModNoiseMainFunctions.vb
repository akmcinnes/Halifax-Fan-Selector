...
Module ModNoiseMainFunctions
    ...
    Public Function OutputDuct(rownum As Integer)
        OutputDuct = 0.0
        Dim txtSPLlabel = New Label()
    ...
    Public Function OutputOpenInlet(rownum As Integer)
        OutputOpenInlet = 0.0
        Dim txtSPLlabel = New Label()
    ...
    Public Function OutputOpenOutlet(rownum As Integer)
    ...
    Public Function OutputBrg(rownum)
        OutputBrg = 0.0
        Dim txtSPLlabel = New Label()
        Dim txtSPL As Label
    ...
    Public Function OutputMotor(rownum)
        OutputMotor = 0.0
        Dim txtSPLlabel = New Label()
        Dim txtSPL As Label
    ...
    Public Function OutputBPF(rownum)
        OutputBPF = 0.0
        Dim txtSPLlabel = New Label()
        Dim txtSPL As Label
