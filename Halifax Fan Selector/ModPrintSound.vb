Module ModPrintSound
    ...
    Public Sub OutputSWLPO(xlsWB, swlrow)
        Try
            xlsWB.ActiveSheet.Name = sheet
            PlaceData(xlsWB, sheet, lang_dict(35), swlrow, 1, True,, True, swlrow, 1, swlrow, 16, 11,, 3)
            PlaceData(xlsWB, sheet, lang_dict(36), swlrow + 1, 1, True,, True, swlrow + 1, 1, swlrow + 1, 8)
            ...
            PlaceData(xlsWB, sheet, lang_dict(37), swlrow + 2, 1,,, True, swlrow + 2, 1, swlrow + 2, 8)
            For count = 0 To 7
                PlaceData(xlsWB, sheet, IDSPL(count), swlrow + 2, count + 9)
            Next count
            PlaceData(xlsWB, sheet, lang_dict(38) & " " & spl2 & " " & lang_dict(39), swlrow + 3, 1,,, True, swlrow + 3, 1, swlrow + 3, 16, 11)
            PlaceData(xlsWB, sheet, lang_dict(40) & " " & bospl2 & " " & lang_dict(39), swlrow + 5, 1,,, True, swlrow + 5, 1, swlrow + 5, 16)
            PlaceData(xlsWB, sheet, lang_dict(41) & " " & bospl1M2 & " " & lang_dict(39), swlrow + 6, 1,,, True, swlrow + 6, 1, swlrow + 6, 16)
        Catch ex As Exception
    ...
    Public Sub OutputductPO(xlsWB, Drow)
        Try
            xlsWB.ActiveSheet.Name = sheet
            PlaceData(xlsWB, sheet, lang_dict(42), Drow, 1, True,, True, Drow, 1, Drow, 16, 11,, 3)
            PlaceData(xlsWB, sheet, lang_dict(43), Drow + 1, 1, True,, True, Drow + 1, 1, Drow + 1, 16)
            PlaceData(xlsWB, sheet, lang_dict(36), Drow + 2, 1, True,, True, Drow + 2, 1, Drow + 2, 8)
            ...
            PlaceData(xlsWB, sheet, lang_dict(44), Drow + 3, 1,,, True, Drow + 3, 1, Drow + 3, 8)
            For count = 0 To 7
                PlaceData(xlsWB, sheet, Ascale(count), Drow + 3, count + 9)
            Next count
            PlaceData(xlsWB, sheet, lang_dict(45) & " " & NCoverall & " " & lang_dict(46), Drow + 4, 1, True, True, True, Drow + 4, 1, Drow + 4, 16, 11)
            With xlsWB.ActiveSheet
    ...
    Public Sub OutputopeninletPO(xlsWB, OIrow)
        Try
            xlsWB.ActiveSheet.Name = sheet
            PlaceData(xlsWB, sheet, lang_dict(47), OIrow, 1, True,, True, OIrow, 1, OIrow, 16, 11,, 3)
            PlaceData(xlsWB, sheet, lang_dict(48) & " " & Math.Round(final.inletdia).ToString & Units(5).UnitName(Units(5).UnitSelected), OIrow + 1, 1,,, True, OIrow + 1, 1, OIrow + 1, 16)
            PlaceData(xlsWB, sheet, lang_dict(43), OIrow + 2, 1, True,, True, OIrow + 2, 1, OIrow + 2, 16, 10)
            PlaceData(xlsWB, sheet, lang_dict(36), OIrow + 3, 1,,, True, OIrow + 3, 1, OIrow + 3, 8)
            ...
            PlaceData(xlsWB, sheet, lang_dict(49), OIrow + 4, 1,,, True, OIrow + 4, 1, OIrow + 4, 8)
            For count = 0 To 7
                PlaceData(xlsWB, sheet, INascale(count), OIrow + 4, count + 9)
            Next count
            PlaceData(xlsWB, sheet, lang_dict(50) & " " & Math.Round(inNCoverall) & " " & lang_dict(46), OIrow + 5, 1, True, True, True, OIrow + 5, 1, OIrow + 5, 16)
            With xlsWB.ActiveSheet
                Dim rowstring As String
    ...
    Public Sub OutputopenoutletPO(xlsWB, OOrow)
        Try
            xlsWB.ActiveSheet.Name = sheet
            PlaceData(xlsWB, sheet, lang_dict(51), OOrow, 1, True,, True, OOrow, 1, OOrow, 16, 11,, 3)
            If final.outletlen > 0 And final.outletwid > 0 Then
                PlaceData(xlsWB, sheet, lang_dict(52) & " " & Math.Round(final.outletlen).ToString & " x " & Math.Round(final.outletwid).ToString & Units(5).UnitName(Units(5).UnitSelected), OOrow + 1, 1,,, True, OOrow + 1, 1, OOrow + 1, 16, 11,, 1)
            Else
                PlaceData(xlsWB, sheet, lang_dict(57) & " " & Math.Round(final.outletdia).ToString & Units(5).UnitName(Units(5).UnitSelected), OOrow + 1, 1,, True, OOrow + 1, 1, OOrow + 1, 16, 11,, 1)
            End If
            PlaceData(xlsWB, sheet, lang_dict(43), OOrow + 2, 1, True,, True, OOrow + 2, 1, OOrow + 2, 16, 10)
            PlaceData(xlsWB, sheet, lang_dict(36), OOrow + 3, 1, True,, True, OOrow + 3, 1, OOrow + 3, 8)
            ...
            PlaceData(xlsWB, sheet, lang_dict(49), OOrow + 4, 1,,, True, OOrow + 4, 1, OOrow + 4, 8)
            For count = 0 To 7
                PlaceData(xlsWB, sheet, OUTascale(count), OOrow + 4, count + 9)
            Next count
            PlaceData(xlsWB, sheet, lang_dict(53) & " " & Math.Round(OUTNCoverall) & " " & lang_dict(46), OOrow + 5, 1, True, True, True, OOrow + 5, 1, OOrow + 5, 16)
            With xlsWB.ActiveSheet
                Dim rowstring As String
    ...
    Public Sub OutputbrgPO(xlsWB, brgrow)
        Try
            PlaceData(xlsWB, sheet, lang_dict(55) & " " & BRGnoise & " dBA", brgrow, 1, True, True, True, brgrow, 1, brgrow, 6) 'Bearing SPL
            xlsWB.ActiveSheet.Name = sheet
            With xlsWB.ActiveSheet
                Dim rowstring As String
    ...
    Public Sub OutputmotorPO(xlsWB, Motorrow)
        Try
            PlaceData(xlsWB, sheet, lang_dict(56) & " " & MTRnoise & " dBA", Motorrow, 1, True, True, True, Motorrow, 1, Motorrow, 6) 'Motor SPL
            xlsWB.ActiveSheet.Name = sheet
            With xlsWB.ActiveSheet
                Dim rowstring As String
    ...
    Public Sub OutputbpfPO(xlsWB, bpfroW)
        Try
            PlaceData(xlsWB, sheet, lang_dict(54) & " " & BPfreq & " Hz", bpfroW, 1, True, True, True, bpfroW, 1, bpfroW, 8) 'BPF
        Catch ex As Exception
